...
Original file is located at
    https://colab.research.google.com/drive/1rH-HKFSYgiphwrv8DBocarmxVXtl0RM-
"""
...
lines = open("/content/gdrive/My Drive/project data/movie_lines.txt", encoding='utf-8',
             errors='ignore').read().split('\n')

convers = open("/content/gdrive/My Drive/project data/movie_conversations.txt", encoding='utf-8',
             errors='ignore').read().split('\n')
...
embeddings_index = {}
with open("/content/gdrive/My Drive/project data/glove.6B.50d.txt", encoding='utf-8') as f:
    for line in f:
        values = line.split()
        word = values[0]
...
while prepro1 != 'q':
    ...
    try:
        ...
        decoded_translation = ''
        #print("decode_translation defined")
